...
#define SDL3_GFXPRIMITIVES_SCOPE extern
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool pixelColor(SDL_Renderer* renderer,
                                             ...
                                             Sint16 y,
                                             Uint32 color);
    SDL3_GFXPRIMITIVES_SCOPE bool pixelRGBA(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a);

    /* Horizontal line */

    SDL3_GFXPRIMITIVES_SCOPE bool hlineColor(
        SDL_Renderer* renderer, Sint16 x1, Sint16 x2, Sint16 y, Uint32 color);
    SDL3_GFXPRIMITIVES_SCOPE bool hlineRGBA(
        SDL_Renderer* renderer, Sint16 x1, Sint16 x2, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a);

    /* Vertical line */

    SDL3_GFXPRIMITIVES_SCOPE bool vlineColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y1, Sint16 y2, Uint32 color);
    SDL3_GFXPRIMITIVES_SCOPE bool vlineRGBA(
        SDL_Renderer* renderer, Sint16 x, Sint16 y1, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a);

    /* Rectangle */

    SDL3_GFXPRIMITIVES_SCOPE bool rectangleColor(
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool boxColor(
        SDL_Renderer* renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool lineColor(
        SDL_Renderer* renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool aalineColor(
        SDL_Renderer* renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool circleColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Sint16 rad, Uint32 color);
    SDL3_GFXPRIMITIVES_SCOPE bool circleRGBA(
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool aacircleColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Sint16 rad, Uint32 color);
    SDL3_GFXPRIMITIVES_SCOPE bool aacircleRGBA(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a);

    /* Filled Circle */

    SDL3_GFXPRIMITIVES_SCOPE bool filledCircleColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Sint16 r, Uint32 color);
    SDL3_GFXPRIMITIVES_SCOPE bool filledCircleRGBA(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a);

    /* Ellipse */

    SDL3_GFXPRIMITIVES_SCOPE bool ellipseColor(
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool aaellipseColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color);
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool filledEllipseColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color);
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool polygonColor(
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool aapolygonColor(
        SDL_Renderer* renderer, const Sint16* vx, const Sint16* vy, int n, Uint32 color);
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool filledPolygonColor(
        SDL_Renderer* renderer, const Sint16* vx, const Sint16* vy, int n, Uint32 color);
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool bezierColor(
    ...
    SDL3_GFXPRIMITIVES_SCOPE bool characterColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, char c, Uint32 color);
    SDL3_GFXPRIMITIVES_SCOPE bool characterRGBA(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, char c, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
    SDL3_GFXPRIMITIVES_SCOPE bool stringColor(
        SDL_Renderer* renderer, Sint16 x, Sint16 y, const char* s, Uint32 color);
