    ...
    : m_cursors(cursors)
{
    ...
    registerCallback(Event::Type::BUILDING_PLACEMENT_STARTED, this, &CursorManager::onBuildingPlacementStarted);
    registerCallback(Event::Type::BUILDING_PLACEMENT_ENDED, this, &CursorManager::onBuildingPlacementEnded);
...
void CursorManager::onTick(const Event& e)
{
    ...
    if (movement < m_mouseMoveThreshold) // Considered cursor is still
    {
