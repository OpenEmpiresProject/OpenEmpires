    ...
    public:
        ...
        void run()
        {
            ...
            while (running)
            {
                ...
                SDL_FRect dstRect = {250 - m_rc.anchor.x * scale, 250 - m_rc.anchor.y * scale, m_rc.srcRect.w * scale, m_rc.srcRect.h * scale};

                SDL_SetTextureColorMod(m_rc.texture, m_rc.shading.r, m_rc.shading.g, m_rc.shading.b);
                SDL_RenderTextureRotated(m_renderer, m_rc.texture, &(m_rc.srcRect), &dstRect, 0, nullptr,
                                        m_rc.flip);
        ...
        void initSDL()
        {
            ...
            m_window =
                SDL_CreateWindow("Studio", 500, 500, SDL_WINDOW_OPENGL);
            if (!m_window)
            {
