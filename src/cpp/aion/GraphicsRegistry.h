  ...
  public:
    ...
    bool operator==(const GraphicsID &other) const
    {
        return entitytType == other.entitytType && actionType == other.actionType &&
               ...
               custom2 == other.custom2 && custom3 == other.custom3;
    }
    ...
    int64_t hash() const
    {
        return (static_cast<int64_t>(entitytType) << 46) |
               ...
               (static_cast<int64_t>(frame) << 23) | (static_cast<int64_t>(custom1) << 13) |
               (static_cast<int64_t>(custom2) << 3) | static_cast<int64_t>(custom3);
    }
    ...
    std::string toString() const
    {
        return "GraphicsID(" + std::to_string(entitytType) + ", " + std::to_string(actionType) +
               ...
               ", " + std::to_string(custom1) + ", " + std::to_string(custom2) + ", " +
