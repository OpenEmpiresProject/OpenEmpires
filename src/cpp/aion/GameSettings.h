...
namespace aion
{
    ...
    public:
        ...
        void setResolution(int width, int height) { resolution.width = width; resolution.height = height; }
        ...
        void setWindowDimensions(int width, int height) { windowDimensions.width = width; windowDimensions.height = height; }
        ...
        utils::WidthHeight getWorldSizeInTiles() const
        {
            ...
            return {worldSize.width / utils::Constants::TILE_SIZE, worldSize.height / utils::Constants::TILE_SIZE};
        }
